...
with open('negativefew.neg', "w") as my_output_Neg_file:
 with open('positivefew.pos', "w") as my_output_Pos_file:
  data = pd.read_csv('csvFew.csv',usecols=[0,1,2,4,7],engine="python")
